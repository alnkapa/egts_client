...
constexpr size_t max_frame_size{65517};
...
class Packet : public egts::v1::Payload {
   ...
   public:
    ...
    void response(uint16_t response_packet_identifier, egts::v1::error::Error processing_result) {
    ...
    egts::v1::Buffer pack() {
        ...
        if (m_packet_type == Type::EGTS_PT_RESPONSE) {  // prepend response id
            egts::v1::Buffer response_buf{
                ...
                static_cast<uint8_t>(m_processing_result)  // 1 byte
            };
